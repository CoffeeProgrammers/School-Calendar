...
public interface TaskRepository extends JpaRepository<Task, Long>, JpaSpecificationExecutor<Task> {
    ...
    Page<Task> findAllByEvent_Id(Long eventId, Pageable pageable, Specification<Task> specification);

    List<Task> findAllByEvent_Id(Long eventId);

    Page<Task> findAllByCreator_IdAndEventIsNull(long creator_id, Pageable pageable, Specification<Task> specification);
